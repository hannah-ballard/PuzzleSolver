...
def BreadthFirstSearch(root):
    ...
    while len(OpenList)>0 and not goalFound:
        ...
        ClosedList.insert(0,tuple(currentNode.puzzle))
        ...
        for child in currentNode.children:
            ...
            elif not Contains(OpenList, child) and not tuple(child.puzzle) in ClosedList:
                OpenList.insert(0,child)
            #elif tuple(child.puzzle) in ClosedList:
            #    print("was in closed list")
